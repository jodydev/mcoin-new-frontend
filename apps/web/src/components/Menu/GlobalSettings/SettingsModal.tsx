                      ...
                      <QuestionHelper
                        text={
                          <>
                            ...
                            <Text my="8px">
                              {t(
                                'It is a tool for indicative purposes only to allow users to check the reference risk level of a MCOIN Chain Smart Contract. Please do your own research - interactions with any MCOIN Chain Smart Contract is at your own risk.',
                              )}
                            </Text>
                          </>
                        }

    ...
    <Container>
        ...
        <Flex flexDirection="column">
          <Flex>
            ...
            <Flex alignItems="center" mr="8px">
              <Text color="textSubtle">1 MCOIN = &nbsp;</Text>
              <Text color="textSubtle">
                {(1000000000000000000 / publicIfoData.listingPrice).toFixed(0)}&nbsp;{publicIfoData.symbol}
              </Text>
            </Flex>
          </Flex>
          <StyledLinkExternal href={publicIfoData.link} mb="8px">
            {t('Learn more about %title%', { title: publicIfoData._name })}
          </StyledLinkExternal>
        </Flex>
      </AchievementFlex>
      <Flex alignItems="flex-end" flexDirection="column">
        <Flex>
          ...
          <Flex alignItems="center" mr="8px">
            <Text color="textSubtle">{Number(publicIfoData.softcap) / 1000000000000000000}&nbsp;MCOIN</Text>
          </Flex>
        </Flex>
        <Flex>
          <Text bold mr="8px">
          ...
          <Flex alignItems="center" mr="8px">
            <Text color="textSubtle">{Number(publicIfoData.hardcap) / 1000000000000000000}&nbsp;MCOIN</Text>
          </Flex>
        </Flex>
        <StyledLinkExternal href={'https://bscscan.com/address/'.concat(publicIfoData.ILOToken.toString())}>
          {t('View Contract')}
        </StyledLinkExternal>
      </Flex>
    </Container>

    ...
    <Modal title={t('', { })} onDismiss={onDismiss}>
      <ModalBody maxWidth="350px">
        ...
        <Text color="textSubtle" fontSize="12px" mb="24px">
          {t(
            'If you don\'t commit enough MCOIN, you may not receive any ILO tokens at all and will only receive a full refund of your MCOIN.',
          )}
        </Text>
        ...
        display={steps===0?"block":"none"}
          ...
          onClick={async ()=>{
            try {
              ...
              if (receipt.status) {
                toastSuccess(t('Wrapped'), t('MCOIN is wrapped'))

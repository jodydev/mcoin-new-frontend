...
if(status!==-2)
  {console.log(publicIfoData.maxUserAmount.toString())
    ...
    <FooterEntry label={t('Max MCOIN entry:')} value={publicIfoData.maxUserAmount.toString()!=="0"?(publicIfoData.maxUserAmount/1000000000000000000).toString().concat(" MCOIN"):"No Limit"} />
  
  
  <FooterEntry label={t('Price Per MCOIN:')} value={(1000000000000000000/publicIfoData.costPresaleBNB).toFixed(0).toString().concat(" ").concat(publicIfoData.symbol.toString())} />

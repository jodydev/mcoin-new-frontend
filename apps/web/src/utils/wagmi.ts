...
const arbitrum1 : Chain = {
  ...
  contracts: {
    multicall3: {
      address: '0x606484a2fc632CB2c8D356502a2DD3aD961F2a46',
...
const bsc1 : Chain = {
  ...
  name: 'M20 Chain',
  network: 'm20',
  nativeCurrency: { name: 'MCoin', symbol: 'MCOIN', decimals: 18 },
  rpcUrls: {
    // default: { http: ['http://66.135.9.150:8545'] }
    default: { http: ['https://rpc1.m20chain.com/'] }
  },
  blockExplorers: {
    etherscan: { name: 'M20Scan', url: 'https://explorer.m20chain.com' },
    default: { name: 'M20Scan', url: 'https://explorer.m20chain.com' }
  },
  contracts: {
    multicall3: {
      address: '0x606484a2fc632CB2c8D356502a2DD3aD961F2a46',
      blockCreated: 10371109      
    }
  }
}
...
//   },
//   blockExplorers: {
//     etherscan: { name: 'MCoinScan', url: 'https://bscscan.com' },
//     default: { name: 'MCoinScan', url: 'https://bscscan.com' }
//   },
//   contracts: {
//     multicall3: {
//       address: '0x606484a2fc632CB2c8D356502a2DD3aD961F2a46',

...
import { bscTokens, bsc1Tokens, BUSD, USDC, USDT } from '@pancakeswap/tokens'
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.cake, bscTokens.cake, bscTokens.wbnb],
  [ChainId.SHIMMER2]: [],
  [ChainId.AVAX]: [],
  [ChainId.FANTOM]: [],
  [ChainId.CRONOS]: [],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.wbnb, bscTokens.usdc, bscTokens.usdt, bscTokens.cake],
  [ChainId.SHIMMER2]: [],
  [ChainId.AVAX]: [],
  [ChainId.FANTOM]: [],
  [ChainId.CRONOS]: [],

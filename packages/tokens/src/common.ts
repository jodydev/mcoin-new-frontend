...
export const CAKE_BSC = new ERC20Token(
  ChainId.BSC,
  '0xFBB37ed1DacDCefeB9A8bb070d6C46B23356794C',
  18,
  'CAKE',
  'PancakeSwap Token',
...
export const USDC_BSC = new ERC20Token(
  ChainId.BSC,
  '0x79CAa44083e8F5fF6b05ca732769E0f51Cc6c75C',
  18,
  'USDC',
...
export const USDT_BSC = new ERC20Token(
  ChainId.BSC,
  '0xa58f8364D2dfa7b1d6F3eFBdacc5046564396785',
  6,
  'USDT',
  'Tether USD',
  'https://tether.to/',
...
export const DAI_BASE = new ERC20Token(
  ChainId.BASE,
...
export const DAI_BSC = new ERC20Token(
  ChainId.BSC,
  '0x5630D753879004F240CB5C3fb171892923fd84BF',
  18,
  'DAI',
  'Dai Stablecoin',
  'https://makerdao.com/',

...
export enum PoolCategory {
  "COMMUNITY" = "Community",
  "CORE" = "Core",
  "BINANCE" = "Binance", // Pools using native MCOIN behave differently than pools using a token
  "AUTO" = "Auto",
}
...
export interface DeserializedCakeVault {
  ...
  totalDexTokenInVault?: BigNumber;
...
export interface Pool extends PoolConfigBaseProps {
  totalStaked?: BigNumber
  stakingLimit?: BigNumber
  startBlock?: number
  endBlock?: number
